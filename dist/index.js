...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function recupererDonneesFormulaire() {
        ...
        var id = generateRandomId(5); // Génère un ID de 5 chiffres
    ...
    var itemsPerPage = parseInt(localStorage.getItem(itemsPerPageStorageKey) || '2');
    ...
    var modifyCargoPopup = document.getElementById('modifyCargoPopup');
    var modifyForm = document.getElementById('modifyForm');
    var openModifyPopup = function (cargo) {
        var _a, _b;
        // Remplir le formulaire avec les informations de la cargaison
        modifyForm.querySelector('#modifyId').value = cargo.id.toString();
        modifyForm.querySelector('#modifyType').value = cargo.type;
        modifyForm.querySelector('#modifyLieuDepart').value = cargo.lieu_depart;
        modifyForm.querySelector('#modifyLieuArriver').value = cargo.lieu_arriver;
        modifyForm.querySelector('#modifyDateDepart').value = cargo.date_depart;
        modifyForm.querySelector('#modifyDateArriver').value = cargo.date_arriver;
        modifyForm.querySelector('#modifyNombreProduits').value = ((_a = cargo.Nombre_produits) === null || _a === void 0 ? void 0 : _a.toString()) || '';
        modifyForm.querySelector('#poids').value = ((_b = cargo.poids) === null || _b === void 0 ? void 0 : _b.toString()) || '';
        modifyForm.querySelector('#modifyDistance').value = cargo.distance.toString();
        modifyForm.querySelector('#modifyStatus').value = cargo.status;
        modifyForm.querySelector('#modifyEtat').value = cargo.etat;
        // Afficher le pop-up
    ...
    (_a = document.getElementById('modifyCancelButton')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', closeModifyPopup);
    //EVENEMENT POUR LE BOUTON SUBMIT DU POPUP
    modifyForm.addEventListener('click', function (event) {
        event.preventDefault();
        var updatedCargo = {
            id: parseInt(modifyForm.querySelector('#modifyId').value),
            type: modifyForm.querySelector('#modifyType').value,
            lieu_depart: modifyForm.querySelector('#modifyLieuDepart').value,
            lieu_arriver: modifyForm.querySelector('#modifyLieuArriver').value,
            date_depart: modifyForm.querySelector('#modifyDateDepart').value,
            date_arriver: modifyForm.querySelector('#modifyDateArriver').value,
            distance: parseInt(modifyForm.querySelector('#modifyDistance').value),
            Nombre_produits: parseInt(modifyForm.querySelector('#modifyNombreProduits').value),
        ...
        cargaisonData = cargaisonData.map(function (cargo) {
            return cargo.id === updatedCargo.id ? updatedCargo : cargo;
        });
    ...
    window.redirectTocargaison = function (cargoId) {
        window.location.href = "pages/cargaison.php?id=".concat(cargoId);
    };
    updateDisplay();
});
export {};
